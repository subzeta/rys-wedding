    ...
    <label class="adult-only-field">
      ...
      <div class="choice-group choice-group--stacked" data-field="dietType" role="radiogroup" aria-label="Tipo de menú">
        <button
          type="button"
          class="choice-btn"
          data-value="Bacalao gratinado a la muselina de ajo, hummus negro y verduritas salteadas"
        >
          Bacalao gratinado a la muselina de ajo, hummus negro y verduritas salteadas
        </button>
        <button
          type="button"
          class="choice-btn"
          data-value="Meloso de ternera con parmentier de patata y salsa de vino tinto del Empordà"
        >
          Meloso de ternera con parmentier de patata y salsa de vino tinto del Empordà
        </button>
